...
type Concat_<TupleA extends AnyTuple, TupleB extends AnyTuple, CounterTuple extends AnyTuple> = CounterTuple extends []
...
export type OfLength<N extends number, FillType = RangeSymbol> = Flatten<OfLength_<N, [], FillType>>;
